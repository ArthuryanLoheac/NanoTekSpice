...
Test(ParseBySpaces, xorLink, .init=redirect_all_std)
{
    ...
    cr_assert_eq(newLink[0].size(), 4);
    cr_assert_str_eq(newLink[0][0].c_str(), "in_1");
    cr_assert_str_eq(newLink[0][1].c_str(), "1");
    cr_assert_str_eq(newLink[0][2].c_str(), "gate");
    cr_assert_str_eq(newLink[0][3].c_str(), "1");
    cr_assert_eq(newLink[1].size(), 4);
    cr_assert_str_eq(newLink[1][0].c_str(), "in_2");
    cr_assert_str_eq(newLink[1][1].c_str(), "1");
    cr_assert_str_eq(newLink[1][2].c_str(), "gate");
    cr_assert_str_eq(newLink[1][3].c_str(), "2");
    cr_assert_eq(newLink[2].size(), 4);
    cr_assert_str_eq(newLink[2][0].c_str(), "out");
    cr_assert_str_eq(newLink[2][1].c_str(), "1");
